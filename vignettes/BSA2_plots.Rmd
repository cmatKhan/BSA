...
for (i in 1:14) {
  ...
  ggsave(p1,
    filename = paste0("/Users/danielagustinho/GoogleDrive/WashU/DNA/EXP#067/Plots/Chromosome_", i, "_nonSmoothed.1kb.pdf"), dpi = 500, height = 9,
    units = "in", width = 16
  )

  ggsave(p2,
    filename = paste0("/Users/danielagustinho/GoogleDrive/WashU/DNA/EXP#067/Plots/Chromosome_", i, "_Lungs15days_nonSmoothed.1kb.pdf"), dpi = 500, height = 9,
    units = "in", width = 16
  )

  ggsave(p3,
    filename = paste0("/Users/danielagustinho/GoogleDrive/WashU/DNA/EXP#067/Plots/Chromosome_", i, "_Brains15days_nonSmoothed.1kb.pdf"), dpi = 500, height = 9,
    units = "in", width = 16
  )
}
...
ggsave(p1,
  filename = paste0("/Users/danielagustinho/GoogleDrive/WashU/DNA/EXP#067/Plots/IR-1_5kb-NONsmoothed.pdf"), dpi = 500, height = 9,
  units = "in", width = 16
)
