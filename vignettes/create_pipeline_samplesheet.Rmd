...
df = readRDS(system.file("bsa6_raw_meta.rds", package = "BSA")) %>%
  ...
  dplyr::select(sample, pool, cond, day, replicate, experiment, 
                runNumber, fastq_1, fastq_2)

#write_csv(df, "/mnt/scratch/sarek/bsa6_samplesheet.csv")
#write_tsv(df, "/mnt/scratch/sarek/bsa6_samplesheet.tsv")
```
