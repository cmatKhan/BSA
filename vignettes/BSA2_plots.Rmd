...
samples <- lapply(c(1:3), FUN = function(x) {
  data.frame(
    ...
    mutate(
      ...
      Condition = rep(condition[x], 
                      nrow(allPools[[names(allPools)[x]]]))
    )
})
...
MaxAndMins <- 
  cbind(allPoolsInOne_filteredBSA[["Y"]][, 1:4], 
        data.frame(
...
# This mutation was erased in the addition of 
# the drug marker in the C8 parent (It was in the arm).
```
