...
plot_by_chrom(x, seqnames(kn99_genome)[[12]], 'YPD_0_24', 'Lung_16_24', 'Lung_9_0')
...
ve <- makeVariantExperimentFromVCF(input_paths$vcf,
                                   out.dir = tempfile(),
                                   fmt.import=c('AD',
                                                'DP',
                                                'PL',
                                                'GQ'),
                                   sample.info='~/code/BSA/sample_info.txt')
```
